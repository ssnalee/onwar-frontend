...
export default function Competitive() {
    ...
    const saveMutation = useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries(['tagNo']);
            setErr(null);
        },
        onError: (err) => {
    ...
    return (
        <>
            ...
            <PostForm>
                <div>
                    <input type="text" placeholder="배틀태그 입력 예) 홍길동#1234" />
                    <Select
                        options={options}
                        isMulti
                ...
                <button onClick={() => handlePostBoard()}>게시글 등록하기</button>
            </PostForm>
            <BoardList>
                {
                            ...
                            <BoardItem key={item.post_id}>
                                ...
                                <BoardCommentContainer>
                                    ...
                                    <div className="comment-post-container">
                                        <textarea placeholder={item.comments?.length > 0 ? "댓글을 작성하세요!" : "댓글의 첫 번째 작성자가 되어보세요!" } />
